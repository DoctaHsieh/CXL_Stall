...
# Set Exceptions
#-----------------------------------------------
# CDC: ip2csr_avmm_clk (125MHz) -> ip2hdm_clk for the stall control registers.
# stall_en is protected by a 2-FF synchronizer; addr/cycles are stable well
# before stall_en rises because software writes 0x1000 before 0x1008.
set_max_delay -to [get_keepers -nowarn {*stall_en_meta*}]     100
set_min_delay -to [get_keepers -nowarn {*stall_en_meta*}]    -100
set_max_delay -to [get_keepers -nowarn {*stall_addr_sync*}]   100
